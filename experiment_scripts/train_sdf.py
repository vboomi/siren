...
p.add_argument("--num_epochs", type=int, default=10000, help="Number of epochs to train for.")

p.add_argument("--epochs_til_ckpt", type=int, default=1, help="Time interval in seconds until checkpoint is saved.")
p.add_argument(
    "--steps_til_summary", type=int, default=100, help="Time interval in seconds until tensorboard summary is saved."
)
